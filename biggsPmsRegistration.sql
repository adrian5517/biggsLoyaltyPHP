...
CREATE TABLE IF NOT EXISTS biggs_branches (
    ...
    has_venue_hall SMALLINT DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS menu (
    ...
    type SMALLINT NOT NULL DEFAULT 0 --tinytint(1) -> SMALLINT (or BOOLEAN if only 0/1)
);
...
CREATE TABLE IF NOT EXISTS users (
    ...
    favorite_menu INTEGER REFERENCES menu(m_id),
    frequented_biggs_location_id INT REFERENCES biggs_branches(id),
    interested_in_events BOOLEAN DEFAULT FALSE,
    interested_in_franchise BOOLEAN DEFAULT FALSE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);


-- Remove DROP TABLE IF EXISTS biggs_branches CASCADE; (not needed in production schema)

INSERT INTO biggs_branches (
    id, title, description, images, created_at, updated_at, contact, latitude, longitude, has_venue_hall
) VALUES

(14, 'BIGGS GOA', '7:00AM - 8:00PM, With Function Hall, San Jose St., Goa, Camarines Sur', ARRAY['66cfc35ea11a53.96310693.png'], '2024-07-04 17:08:33', '2024-09-10 23:40:53', '0928-664-4114', 13.698134654934885, 123.4897009251598, 1),

(15, 'BIGGS IRIGA', '8:00AM - 9:00PM, With FoodPanda & Function Hall, San Roque, Iriga City', ARRAY['66cfc377c70269.53103733.png'], '2024-07-04 17:09:20', '2024-09-12 00:17:40', '0907-904-1992', 13.421369382411509, 123.4121244123936, 1),

(17, 'BIGGS SM NAGA', '10:00AM - 9:00PM, SM City Naga Triangulo', ARRAY['66cfc38323d474.17095477.png'], '2024-07-04 17:23:33', '2024-09-10 23:05:21', '0994-230-9660', 13.620584135135939, 123.18990514721712, 0),

(31, 'BIGGS BARLIN', '7:00AM - 10:00PM, With FoodPanda & Function Hall, Naga City', ARRAY['66cfc3b1993744.61993949.png'], '2024-08-04 20:56:54', '2024-09-10 23:07:27', '0916-332-2258', 13.62714418756896, 123.18655325212642, 1),

(32, 'BIGGS Robinson', '10:00AM - 9:00PM, Robinsons Place Naga', ARRAY['66cfc3bbad9b67.52558676.png'], '2024-08-04 20:58:53', '2024-09-10 23:07:07', '0995-842-4394', 13.614724683883027, 123.19275224297968, 0),

(33, 'BIGGS Emerald', '9AM-9PM, With FoodPanda & Function Hall, Naga City', ARRAY['66cfc3c67b5e40.59990367.png'], '2024-08-04 21:01:13', '2024-09-10 23:06:51', '0992 961 9982', 13.643278673717752, 123.20481463392119, 1),

(34, 'BIGGS Centro NAGA', '24HRS, With FoodPanda & Function Hall, Naga City', ARRAY['66cfc3d889cd52.61111850.png'], '2024-08-04 22:03:17', '2024-09-10 23:06:38', '0956-934-0799', 13.624735393757605, 123.18573540267226, 1),

(35, 'BIGGS PILI', '24HRS, With FoodPanda & Function Hall, Pili, Cam Sur', ARRAY['66cfc3e3c61d31.17410180.png'], '2024-08-04 22:04:56', '2024-09-10 23:06:24', '0917-172-4447', 13.570567389434569, 123.26536290376461, 1),

(37, 'BIGGS Magsaysay', '24HRS, With FoodPanda & Function Hall, Naga City', ARRAY['66e137179edec5.34862951.png'], '2024-09-10 23:22:15', '2024-09-11 02:01:33', '0993-613-7348', 13.630974473427537, 123.19669837546351, 1),

(27, 'BIGGS BIA', '4:00AM - 7:00PM, Airport, Daraga', ARRAY['66cfc38d5b1b80.27307739.png'], '2024-08-02 02:18:57', '2024-09-10 23:08:17', '0935-110-1728', 13.111230687175443, 123.68198464957464, 0),

(28, 'Biggs CAMALIG', '24HRS, Camalig', ARRAY['66cfc39916bc82.93169621.png'], '2024-08-02 02:19:30', '2024-09-10 23:07:59', '0917-143-0122', 13.178164157615797, 123.64360104930417, 1),

(36, 'Biggs Pacific Mall', '10AM-8PM, Legazpi', ARRAY['66cfc3f25edf53.62313944.png'], '2024-08-04 22:06:54', '2024-09-10 23:45:08', '0916-332-2158', 13.145523064780104, 123.74994515040025, 1),

(38, 'BIGGS SM LEGAZPI', '10AM-9PM, SM Legazpi', ARRAY['66e2949022957.jpg'], '2024-09-12 00:13:20', '2024-09-12 00:13:20', '0917-715-3367', 13.144111858438341, 123.74482240795365, 0),

(39, 'BIGGS AYALA MALLS', '10AM-8PM, Ayala Legazpi', ARRAY['66e294c99bc2a.png'], '2024-09-12 00:14:17', '2024-09-12 00:14:17', '0917-165-5000', 13.147258699763764, 123.75215040283474, 0),

(29, 'Biggs SM SORSOGON', '8:00AM - 11:00PM, SM Sorsogon', ARRAY['66cfc3a3def788.38085444.png'], '2024-08-02 02:20:09', '2024-09-10 23:07:41', '0995-192-1944', 12.975703894789698, 124.01977122577422, 0),

(40, 'BIGGS SM LIPA', '10AM-9PM, SM Lipa', ARRAY['672c7801eac71.jpg'], '2024-11-07 01:17:34', '2024-11-07 01:17:34', '0916-332-2017', 13.954507532912212, 121.16403834666019, 0),

(41, 'BIGGS BMC', '7AM-9PM, Naga', ARRAY['673159eb7e645.JPG'], '2024-11-10 18:12:12', '2024-11-10 18:12:12', '0970-668-1150', 13.623093832632762, 123.19949269292583, 0),

(43, 'BIGGS DAET', '10AM-9PM, SM Daet', ARRAY['6731701c13b57.jpg'], '2024-11-10 19:46:52', '2024-11-10 19:46:52', '0991-176-7214', 14.12128240255378, 122.94592373599205, 0),

(44, 'BIGGS SIPOCOT', '24HRS, Sipocot', ARRAY['67329df07e215.jpg'], '2024-11-11 17:14:42', '2024-11-11 17:14:42', '0994-757-1807', 13.747749733198745, 122.97398426118464, 1),

(45, 'BIGGS MASBATE', '8:30AM - 8PM, Masbate', ARRAY['67329ed827ab8.jpg'], '2024-11-11 17:18:32', '2024-11-11 17:18:32', '0916-332-2123', 12.360038006950026, 123.62533945034058, 1),

(46, 'BIGGS OLD ALBAY', '24HRS, Legazpi', ARRAY['6732a223080c2.JPG'], '2024-11-11 17:32:35', '2024-11-11 17:32:35', '0916-332-2177', 13.138718810373124, 123.7362143753515, 1),

(48, 'BIGGS Polangui', '9AM-10PM, Polangui', ARRAY['675819bb143bb.jpeg'], '2024-12-10 03:34:00', '2024-12-10 03:34:00', '09076311821', 13.292606001050626, 123.49013962469664, 1),

(49, 'BIGGS PAGBILAO', '24HRS, Quezon', ARRAY['693920dfd1185.jpg'], '2025-12-10 00:27:29', '2025-12-10 00:27:29', '09278854651', 13.959918822632648, 121.65252165077797, 1),

(50, 'Biggs Grande', '24HRS, Naga', ARRAY['693921b9854ee.jpg'], '2025-12-10 00:31:06', '2025-12-10 00:31:06', '09275852042', 13.621516627043208, 123.2172549243273, 1),

(51, 'BIGGS TABACO', '24HRS, Tabaco', ARRAY['6964bd068d779.jpg'], '2026-01-12 02:21:11', '2026-01-12 02:21:11', '09369558498', 13.355738692596226, 123.73056753458862, 1);
...
CREATE TABLE IF NOT EXISTS user_favorite_menu (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_favorite_menu_user
        FOREIGN KEY (user_tag_id)
        REFERENCES users(tag_id)
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT fk_user_favorite_menu_menu
        FOREIGN KEY (menu_id)
        REFERENCES menu(m_id)
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT uq_user_menu UNIQUE (user_tag_id, menu_id)
);
...
INSERT INTO store_stats (id, title, stats, created_at, updated_at) VALUES
(1, 'Views', '122', '2024-09-12 08:08:22', '2024-09-12 16:08:33'),
(2, 'Menu', '23', '2024-04-22 06:19:37', '2024-09-12 16:10:25'),
(3, 'Employees', ' 726 
', '2024-04-22 06:19:37', '2024-05-07 14:37:02'),
(4, 'Followers', '45000', '2024-04-22 06:19:37', '2024-05-07 14:37:15'),
(5, 'Stores', '24', '2024-04-22 06:19:37', '2024-09-12 16:08:30');

-- =========================================================
-- RESET IDENTITY/SEQUENCE VALUES
-- =========================================================
SELECT setval(pg_get_serial_sequence('menu', 'm_id'), COALESCE((SELECT MAX(m_id) FROM menu), 1), true);
SELECT setval(pg_get_serial_sequence('store_stats', 'id'), COALESCE((SELECT MAX(id) FROM store_stats), 1), true);

-- =========================================================
-- AUTO-UPDATE updated_at TRIGGER FOR PostgreSQL
-- =========================================================
...
DROP TRIGGER IF EXISTS trg_store_stats_updated_at ON store_stats;

CREATE TRIGGER trg_store_stats_updated_at
